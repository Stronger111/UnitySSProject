...
public class LitShaderGUI : ShaderGUI
{
    ...
    ClipMode Clipping
    {
        set { FindProperty("_Clipping", properties).floatValue = (float)value;
    ...
    bool ReceiveShadows
    {
        set {FindProperty("_ReceiveShadows",properties).floatValue=value?1:0;
    ...
    {
        set { FindProperty("_PremulAlpha", properties).floatValue = value ? 1 : 0;
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        showPresets = EditorGUILayout.Foldout(showPresets,"Presets",false);
        if(showPresets)
        {
            OpaquePreset();
            ClipPreset();
    ...
    {
        if (!GUILayout.Button("Transparent Preset"))
        {
            return;
        }
